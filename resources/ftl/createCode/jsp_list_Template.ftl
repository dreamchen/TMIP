                    ...
                    <table>
						...
						<span class="input-icon">
                            ...
                            <td><input class="span10 date-picker" name="lastLoginStart" id="lastLoginStart"
                                       value="${r"${pd.lastLoginStart}"}" type="text" data-date-format="yyyy-mm-dd"
                            ...
                            <td><input class="span10 date-picker" name="lastLoginEnd" id="lastLoginEnd"
                                       value="${r"${pd.lastLoginEnd}"}" type="text" data-date-format="yyyy-mm-dd"
                                        ...
                                        <tr>
                                            <td class='center' style="width: 30px;">
                                                <label><input type='checkbox' name='ids'
                                                              value="${r"${var."}${objectNameUpper}_ID${r"}"}"/><span
                                                        ...
                                                        <ul class="dropdown-menu dropdown-icon-only dropdown-light pull-right dropdown-caret dropdown-close">
                                                            <c:if test="${r"${QX.edit == 1 }"}">
                                                                <li><a style="cursor:pointer;" title="编辑"
                                                                       onclick="edit('${r"${var."}${objectNameUpper}_ID${r"}"}');"
                                                            ...
                                                            <c:if test="${r"${QX.del == 1 }"}">
                                                                <li><a style="cursor:pointer;" title="删除"
                                                                       onclick="del('${r"${var."}${objectNameUpper}_ID${r"}"}');"
                            ...
                            <tr>
                                ...
                                <td style="vertical-align:top;">
                                    <div class="pagination"
                                         style="float: right;padding-top: 0px;margin-top: 0px;">${r"${page.pageStr}"}</div>
                                </td>
                            </tr>
                        </table>
                    </div>
