    ...
    <div class="span6">
        <div class="tabbable">
            <ul class="nav nav-tabs" id="myTab">
                <li class="active"><a data-toggle="tab" href="#home"><i class="green icon-home bigger-110"></i> 配置
                    NO1</a></li>
                    ...
                    <form action="head/saveSys3.do" name="Form3" id="Form3" method="post">
                        ...
                        <table id="table_report" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="WIMIP" id="WIMIP" value="${pd.WIMIP }"
                                           placeholder="请输入服务器地址" style="width:90%" title="服务器地址"/></td>

                                <td style="width:50px;text-align: right;padding-top: 13px;">端口:</td>
                                <td><input type="number" name="WIMPORT" id="WIMPORT" value="${pd.WIMPORT }"
                                           placeholder="端口" style="width:90%" title="端口"/></td>
                            </tr>
                        </table>
                        ...
                        <table id="table_report" class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                <td style="width:50px;text-align: right;padding-top: 13px;">地址:</td>
                                <td><input type="text" name="OLIP" id="OLIP" value="${pd.OLIP }" placeholder="请输入服务器地址"
                                           style="width:90%" title="服务器地址"/></td>

                                <td style="width:50px;text-align: right;padding-top: 13px;">端口:</td>
                                <td><input type="number" name="OLPORT" id="OLPORT" value="${pd.OLPORT }"
                                           placeholder="端口" style="width:90%" title="端口"/></td>
                            </tr>
                        </table>
