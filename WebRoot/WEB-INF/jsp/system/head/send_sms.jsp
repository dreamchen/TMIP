    ...
    <div class="commitbox">
        <div class="commitbox_inner">
            <div class="commitbox_top">
                <textarea name="PHONEs" id="PHONEs" placeholder="请选输入对方手机号,多个请用(;)分号隔开"
                          title="请选输入对方手机号,多个请用(;)分号隔开"></textarea>
        ...
        <tr>
            <td style="margin-top:0px;">
                <div style="float: left;"><textarea name="PHONE" id="PHONE" rows="1" cols="50"
                                                    style="width:530px;height:20px;" placeholder="请选输入对方手机号,多个请用(;)分号隔开"
                                                    title="请选输入对方手机号,多个请用(;)分号隔开">${pd.PHONE}</textarea></div>
                <div style="float: right;"><a class='btn btn-mini btn-info' title="编辑手机号" onclick="dialog_open();"><i
                        class='icon-edit'></i></a></div>
            </td>
        </tr>
        <tr>
            <td id="nr">
                <textarea name="CONTENT" id="CONTENT" style="width:98%;height:165px;" rows="7" cols="50"
                          title="第三方短信内容需要提交官方审核,否则发送失败!">您的验证码是：12358 。请不要把验证码泄露给其他人。</textarea>
            </td>
        </tr>
        <tr>
            <td style="text-align: center;">
                ...
                <label style="float:left;padding-left: 32px;"><input name="form-field-radio" id="form-field-radio1"
                                                                     ...
                                                                     type="radio" value="icon-edit"><span class="lbl">短信接口1</span></label>
