                    ...
                    <tr>
                        ...
                        <td>
                            <div class="commitbox_cen">
                                ...
                                <div class="right"><span class="save" onClick="saveD()">保存</span>&nbsp;&nbsp;<span
        ...
        <table border="0">
            <tr>
                ...
                <td><input type="text" name="objectName" id="objectName" value="" placeholder="这里输入处理类名称"
                           style="width:200px" title="类名称"/></td>
                <td>&nbsp;&nbsp;<font color="red" style="font-weight: bold;">类名首字母必须为大写字母或下划线</font></td>
                <td style="width:76px;text-align: right;">表前缀：</td>
                <td><input type="text" name="tabletop" id="tabletop" value="TB_" placeholder="这里输入表前缀"
                           style="width:60px" title="表前缀"/></td>
            </tr>
        </table>
