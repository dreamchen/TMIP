...
<form action="dictionaries/save.do" name="Form" id="Form" method="post">
    ...
    <div id="zhongxin">
        <table>
            ...
            <tr class="info">
                <td><input type="text" name="BIANMA" id="BIANMA" placeholder="这里输入编码" value="${pd.BIANMA }" title="编码"/>
                </td>
            </tr>
            <tr class="info">
                <td><input type="number" name="ORDY_BY" id="ORDY_BY" placeholder="这里输入序号" value="${pd.ORDY_BY}"
                           title="序号"/></td>
            </tr>
            <tr>
    ...
    <div id="zhongxin2" class="center" style="display:none"><br/><br/><br/><img src="static/images/jzx.gif"
