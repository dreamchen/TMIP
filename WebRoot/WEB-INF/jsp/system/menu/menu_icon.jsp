...
<form action="menu/editicon.do" name="menuForm" id="menuForm" method="post">
    ...
    <div id="zhongxin">
        <table id="table_report" class="table table-striped table-bordered table-hover">
            ...
            <tr>
                <td><label onclick="seticon('icon-group');"><input name="form-field-radio" type="radio"
                                                                   value="icon-edit"><span class="lbl">&nbsp;<i
                        class="icon-group"></i></span></label></td>
                <td><label onclick="seticon('icon-building');"><input name="form-field-radio" type="radio"
                                                                      value="icon-edit"><span class="lbl">&nbsp;<i
                        class="icon-building"></i></span></label></td>
                <td><label onclick="seticon('icon-food');"><input name="form-field-radio" type="radio"
                                                                  value="icon-edit"><span class="lbl">&nbsp;<i
                        class="icon-food"></i></span></label></td>
                <td><label onclick="seticon('icon-user-md');"><input name="form-field-radio" type="radio"
                                                                     value="icon-edit"><span class="lbl">&nbsp;<i
                        class="icon-user-md"></i></span></label></td>
                <td><label onclick="seticon('icon-circle');"><input name="form-field-radio" type="radio"
                                                                    value="icon-edit"><span class="lbl">&nbsp;<i
                        class="icon-circle"></i></span></label></td>
                <td><label onclick="seticon('icon-heart');"><input name="form-field-radio" type="radio"
                                                                   value="icon-edit"><span class="lbl">&nbsp;<i
                        class="icon-heart"></i></span></label></td>
                <td><label onclick="seticon('icon-lock');"><input name="form-field-radio" type="radio"
