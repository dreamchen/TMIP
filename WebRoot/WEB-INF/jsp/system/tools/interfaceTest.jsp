                    ...
                    <div class="widget-body">
                        ...
                        <div class="widget-main">
                            ...
                            <div class="step-content row-fluid position-relative">
                                <label style="float:left;padding-left: 5px;"><input name="form-field-radio1"
                                                                                    id="form-field-radio1"
                                                                                    onclick="setType('POST');"
                                                                                    type="radio" value="icon-edit"
                                                                                    checked="checked"><span class="lbl">POST</span></label>
                                <label style="float:left;padding-left: 15px;"><input name="form-field-radio1"
                                                                                     id="form-field-radio2"
                                                                                     onclick="setType('GET');"
                                                                                     type="radio"
                                                                                     value="icon-edit"><span
                                        class="lbl">GET</span></label>

                                <label style="float:left;padding-left: 35px;"><input name="key" id="form-field-radio1"
                                                                                     type="radio" value="icon-edit"
                                                                                     checked="checked"><span
                                        class="lbl">加密参数:</span></label>
                                <label style="float:left;padding-left: 5px;margin-top: -5px;"><input name="S_TYPE_S"
                                                                                                     id="S_TYPE_S"
                                                                                                     style="width:79px;"
                                                                                                     type="text"
                                                                                                     value="USERNAME"
							...
							<span class="input-icon">
								<input type="text" id="serverUrl" title="输入请求地址"
                                       value="<%=basePath%>/appuser/getAppuserByUm.do?USERNAME=dsfsd"
                                       style="width:540px;">
