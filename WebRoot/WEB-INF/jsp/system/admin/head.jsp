<div class="navbar navbar-inverse">
    <div class="navbar-inner">
        <div class="container-fluid">
            <a href="javascript:void(0);" class="brand" data-toggle="fullscreen">
                <small><i class="icon-leaf"></i> ${pd.SYSNAME}</small>
            </a>
            ...
            <ul class="nav ace-nav pull-right">
                ...
                <li class="light-blue user-profile">
                    <a class="user-menu dropdown-toggle" href="javascript:" data-toggle="dropdown">
                        <img alt="Tienn" src="static/avatars/user.jpg" class="nav-user-photo"/>
							<span id="user_info">
							</span>
