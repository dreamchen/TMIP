...
<head>
    ...
    <script type="text/javascript">
        ...
        function delP(tpurl, id) {
            if (confirm("确定要删除图片？")) {
                var url = "<%=basePath%>link/deltp.do?tpurl=" + tpurl + "&id=" + id + "&guid=" + new Date().getTime();
...
<body>
<form action="link/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
