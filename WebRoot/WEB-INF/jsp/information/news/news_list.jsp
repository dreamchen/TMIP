    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                ...
                <!-- 检索  -->
                <form action="news/list.do?isM1=${pdm.isM1 }&isM2=${pdm.isM2 }" method="post" name="userForm"
                      id="userForm">
                    <table border='0'>
                        <tr>
						...
						<span class="input-icon">
                            ...
                            <td>
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="publisher"
                                   value="${pd.publisher }" placeholder="这里输入发布人"/>
							<i id="nav-search-icon" class="icon-search"></i>
						</span>
                            </td>
                            ...
                            <td style="vertical-align:top;">
                                <select class="chzn-select" name="recommand" data-placeholder="推荐否"
                            ...
                            <td style="vertical-align:top;"><a class="btn btn-mini btn-light" onclick="createHtml();"
                                                               title="生成html"><i id="nav-search-icon"
                                                                                 class="icon-cog"></i></a></td>
                        </tr>
                    </table>
                    <!-- 检索  -->
                                ...
                                <c:if test="${QX.cha == 1 }">
                                    <c:forEach items="${varList}" var="var" varStatus="vs">
                                        ...
                                        <tr>
                                            ...
                                            <td>${var.hits}</td>
                                            <td>
                                                <c:if test="${var.recommand == '0' }"><span
                                                        class="label label-important arrowed-in">未推荐</span></c:if>
                                                <c:if test="${var.recommand == '1' }"><span
                                                        class="label label-success arrowed">已推荐</span></c:if>
                                            </td>
                                            <td>
