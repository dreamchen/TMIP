    ...
    <table style="width:100%;" border="0">
        <tr>
            ...
            <td style="width:100%;" valign="top">
                <iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/classinfo/list.do?DEPT=${pd.ORG_ID }";
...
<SCRIPT type="text/javascript">
    ...
    function zTreeOnClick(event, treeId, treeNode) {
	    document.getElementById("treeFrame").src="<%=basePath%>/classinfo/list.do?DEPT="+treeNode.id;
   	}
   	
   	function getUrlByNodeId(treeId, treeNode) {
	  return "<%=basePath%>/classinfo/list.do?treeNodeId="+treeNode.id;
	}
