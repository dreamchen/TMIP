                                        ...
                                        <tr>
                                            <td class='center' style="width: 30px;">
                                                <label><input type='checkbox' name='ids'
                                                              value="${var.CLASSINFO_ID}"/><span
                                                        class="lbl"></span></label>
                                            </td>
                                            <td class='center' style="width: 30px;">${vs.index+1}</td>
                                            <td>${var.KINDERGARTEN_ID}</td>
                                            <td><a href="<%=basePath%>classinfo/findById.do?CLASSINFO_ID=${var.CLASSINFO_ID}">${var.CLASS_NAME}</a></td>
                                            <td>${var.QUANTITY}</td>
                                            <td>${var.MAIN_TEACHER_ID}</td>
