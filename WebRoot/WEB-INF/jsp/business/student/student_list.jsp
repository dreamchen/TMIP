                ...
                <form action="student/list.do" method="post" name="Form" id="Form">
                    <table>
						...
						<span class="input-icon">
							<input autocomplete="off" id="nav-search-input" type="text" name="keyword" value=""
                                   placeholder="这里输入关键词"/>
                                                        ...
                                                        <ul class="dropdown-menu dropdown-icon-only dropdown-light pull-right dropdown-caret dropdown-close">
                                                            ...
                                                            <c:if test="${QX.del == 1 }">
                                                                <li><a style="cursor:pointer;" title="删除"
                                                                       onclick="del('${var.STUDENT_ID}');"
                                                                       class="tooltip-error" data-rel="tooltip" title=""
                                                                       data-placement="left">
                                                                       <span class="red"><i class="icon-trash"></i></span> </a></li>
                                                            </c:if>
                                                            
                                                            <c:if test="${QX.add==1 }">
                                                            	<li>
                                                            		<a style="cursor:pointer;" title="监护人信息"
                                                                       class="tooltip-success" data-rel="tooltip" title=""
                                                                       data-placement="left"
                                                                       href="<%=basePath%>parent/listByStudentId.do?STUDENT_ID=${var.STUDENT_ID}">
                                                                       <span class="green"><i class="icon-eye-open"></i></span> </a>
                                                            	</li>
                                                            </c:if>
                                                        </ul>
                                                    </div>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        diag.Drag = true;
        diag.Title = "新增";
        diag.URL = '<%=basePath%>student/goAdd.do?param=xx&param1=xb';
        diag.Width = 450;
        diag.Height = 355;
    ...
    function edit(Id) {
        ...
        diag.Drag = true;
        diag.Title = "编辑";
        diag.URL = '<%=basePath%>student/goEdit.do?STUDENT_ID=' + Id+"&param=xx&param1=xb";
        diag.Width = 450;
        diag.Height = 355;
        diag.CancelEvent = function () { //关闭事件
            if (diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none') {
