(function (b, c) {
    ...
    b.fn.ace_file_input = function (d) {
        ...
        this.each(function () {
                    ...
                    return function (z) {
                        b(y).one("load", function () {
                            ...
                            b(y).css({
                                ...
                                width: A,
                                height: C
                            }).attr({src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg=="}).show()
                        });
            ...
            var g = function () {
                n.attr({"data-title": e.btn_choose, "class": ""}).find("span:first").attr({
